...
// there is no need for a nextQDiv. The DOM should only have one question at a time. JD
// var nextQDiv = $("#nextQ");
var correctAnswer = [];

// Handle the modal as part of another issue. JD
// var modal = document.getElementById("myModal");
var myScore = 0; // I believe the initial score should be set to 0. JD
...
function showQuestion(){
    ...
    // empty the question container div to clear the previous question. JD
    ...
    // nextButton when the user chooses an answer. JD
...
questionContainerDiv.on("click", ".q-choice", function() {
    ...
    if (q.correctAnswer === $(this).val()) { // <---- fixed
        ...
        // issue is done and Nilou's issue is done. JD
        //display modal
        // $(function () {
        //     $("#myModal").modal();
        // });
